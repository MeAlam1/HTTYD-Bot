/**Description:
 * This embed used in the command /apply after selecting the Concept Artist.
 * src\components\selects\HTOAD\Application\ApplySelect.js
 */

const { EmbedBuilder } = require('discord.js');

const HTOADConceptArtistApplyEmbed = new EmbedBuilder()
    .setColor(0x0099FF)
    .setTitle(`Concept Artist Application`)
...
module.exports = HTOADConceptArtistApplyEmbed;