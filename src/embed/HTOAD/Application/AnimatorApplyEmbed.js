/**Description:
 * This embed used in the command /apply after selecting the Animator.
 * src\components\selects\HTOAD\Application\ApplySelect.js
 */

const { EmbedBuilder } = require('discord.js');

const HTOADAnimatorApplyEmbed = new EmbedBuilder()
    .setColor(0x0099FF)
    .setTitle(`Animator Application`)
    ...
    { name: `Question list:`, value: `
        ...
        **4.** Do you have any prior experience with animating?
...
module.exports = HTOADAnimatorApplyEmbed;